...
st.set_page_config(page_title="Rinon — LINE Team", page_icon="🟣", layout="wide", initial_sidebar_state="collapsed")
...
with tab_team:
    render_kanban(tasks, TEAM_COLUMNS, members, key_prefix="rit_", use_owner=True)
...
with tab_me:
    ...
    render_personal_kanban(tasks, MY_NAME, members, key_prefix="rim_")
